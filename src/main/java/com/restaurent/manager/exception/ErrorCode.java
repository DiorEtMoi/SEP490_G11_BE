...
public enum ErrorCode {
    ...
    ACCOUNT_NOT_NULL(400,"Account id not null", HttpStatus.BAD_REQUEST),
    RESTAURANT_NOT_NULL(400,"Restaurant id not null",HttpStatus.BAD_REQUEST),
    PACKAGE_NOT_NULL(400,"Package id not null", HttpStatus.BAD_REQUEST),
    MONTHS_NOT_NULL(400,"Months not null", HttpStatus.BAD_REQUEST)
    ;
