...
public class SecurityConfig{
    private final String[] PUBLIC_ENDPOINT = {"/api/identify/refresh-token/{token}","/api/package/view","/api/account/verify/otp","/websocket/**","/api/identify/employee/login","/api/account","/api/account/**","/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html","/swagger-ui/index.html","/api/identify/*","/oauth2/**,/login/oauth2/code/google"};
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(request ->
                request.requestMatchers(PUBLIC_ENDPOINT).permitAll()
                        ...
                        .requestMatchers(EMPLOYEE_MANAGER_ENDPOINT).hasRole(RoleSystem.MANAGER.name())
